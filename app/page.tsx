...
type InspectorTab = 'screen' | 'cabinet' | 'engineering' | 'calc' | 'canvas' | 'project';
...
export default function Home() {
  ...
  const engineering = useMemo(() => buildCabinetEngineering({
    screenId: activeDraft.id,
    columns: screen.columns,
    rows: screen.rows,
    numberingMode,
    receiverCardModel: activeDraft.receiverCardModel,
    processorModel: activeDraft.processorModel,
    defaultDataPort: activeDraft.defaultDataPort,
    defaultPowerLine: activeDraft.defaultPowerLine,
    defaultConfigFile: activeDraft.defaultConfigFile ?? cabinet.configFile,
  }), [activeDraft.id, activeDraft.receiverCardModel, activeDraft.processorModel, activeDraft.defaultDataPort, activeDraft.defaultPowerLine, activeDraft.defaultConfigFile, screen.columns, screen.rows, numberingMode, cabinet.configFile]);

  const selectedEngineeringCabinet = engineering.cabinets.find((item) => item.index === selectedCabinet);
