...
export default function Home() {
  ...
  const engineering = useMemo(() => buildCabinetEngineering({
    ...
    rows: screen.rows,
    numberingMode,
    defaultConfigFile: cabinet.configFile,
  }), [activeDraft.id, screen.columns, screen.rows, numberingMode, cabinet.configFile]);
